        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NombreEspecialidad = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    IdEstadoEspecialidad = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HInicio = table.Column<int>(type: "int", nullable: false),
                    MInicio = table.Column<int>(type: "int", nullable: false),
                    HFin = table.Column<int>(type: "int", nullable: false),
                    MFin = table.Column<int>(type: "int", nullable: false),
                    IdEstado = table.Column<int>(type: "int", nullable: false),
                    NombreHorario = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrimerNombre = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    PrimerApellido = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    SegundoNombre = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    SegundoApellido = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    ...
                    IdPaisNacimiento = table.Column<int>(type: "int", nullable: false),
